# Описание проекта:
Сравнение Москвы и Петербурга окружено мифами. На данных Яндекс Музыки произведено сравнение поведения пользователей двух столиц.
...
# Выводы:
Произведена проверка всех гипотезы и установленно:
